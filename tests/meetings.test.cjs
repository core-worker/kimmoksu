...
(async () => {
    ...
    console.log('PASS: shared publishing, private drafts, edit isolation, escaping, search, revision conflict, save failures/recovery, logout and permission revocation.');
